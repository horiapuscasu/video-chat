(function ($) {
	$.fn.emoji = function (params) {
		...
		this.each(function (n, input) {
			...
			var $button = $("<span>").html(settings.button).css({cursor: 'pointer', 'font-size': settings.fontSize,'vertical-align':'top'}).on('click', showEmoji);
			var $list = $('<div class="emoji" style="vertical-align:top;">').css(defaults.listCSS).css(settings.listCSS);
